...
export const news: News[] = [
  ...
  },
  {
    ...
    content: 'Bổ sung thêm 50 bài học Tiếng Anh nâng cao dành cho học sinh lớp 7-9...',
    excerpt: '50 bài học mới với video và bài tập tương tác.',
    thumbnailUrl: 'https://placehold.co/800x400/2ecc71/white?text=English+Course',
    category: 'COURSE',
    isPinned: false,
    status: 'PUBLISHED',
  ...
  },
  {
    ...
    content: 'Đăng ký ngay giải vô địch Toán học tháng 2 với tổng giải thưởng 10,000 xu...',
    excerpt: 'Giải thưởng lên đến 10,000 xu. Đăng ký trước 14/02.',
    thumbnailUrl: 'https://placehold.co/800x400/e74c3c/white?text=Math+Championship',
    category: 'EVENT',
    isPinned: false,
    status: 'PUBLISHED',
  ...
  },
  {
    ...
    content: 'Từ ngày 10-17/02/2026, tất cả hoạt động học tập sẽ nhận được gấp đôi XP...',
...
export const announcements: Announcement[] = [
  ...
  },
  {
    ...
    content: 'Xin chúc mừng 10 học sinh có thành tích xuất sắc nhất trong tháng 1/2026!',
    type: 'SUCCESS',
    priority: 2,
    isPinned: false,
  ...
  },
  {
    ...
    content: 'Hệ thống vẫn hoạt động bình thường trong dịp Tết. Chúc các bạn một năm mới an khang!',
    type: 'INFO',
    priority: 3,
    isPinned: false,
    startsAt: '2026-02-01T00:00:00Z',
...
export const events: Event[] = [
  {
    ...
    description: 'Hướng dẫn phương pháp học Toán hiệu quả cùng thầy giáo Nguyễn Văn A.',
  ...
  },
  {
    ...
    description: 'Giải đấu Toán học quy mô lớn nhất tháng 2 với tổng giải thưởng 10,000 xu.',
...
export function isAnnouncementRead(userId: string, announcementId: string): boolean {
  return announcementReads.some((r) => r.userId === userId && r.announcementId === announcementId);
}
...
export function getEventRegistrationCount(eventId: string): number {
  return eventRegistrations.filter((r) => r.eventId === eventId && r.status !== 'CANCELLED').length;
}

export function getUserEvents(userId: string): (EventRegistration & { event: Event })[] {
...
export function getNewsCards(): NewsCard[] {
  return getPublishedNews().map((n) => ({
    ...
    title: n.title,
    excerpt: n.excerpt,
    thumbnail: n.thumbnailUrl || 'https://placehold.co/800x400/333/white?text=News',
    category: n.category,
...
export function getEventCards(userId: string): EventCard[] {
  return getUpcomingEvents().map((e) => {
    ...
    const isFull = e.maxParticipants !== null && registrationCount >= e.maxParticipants;
    ...
    return {
      ...
      banner: e.bannerUrl || 'https://placehold.co/800x400/333/white?text=Event',
      type: e.type,
