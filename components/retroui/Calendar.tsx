...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'bg-background group/calendar w-full p-3 shadow-md outline-2 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
      ...
      classNames={{
        ...
        weekday: cn('flex-1 font-normal text-sm select-none', defaultClassNames.weekday),
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'outline-border data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-secondary data-[range-middle=true]:hover:text-secondary-foreground data-[range-middle=true]:text-secondary-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring-1 group-data-[focused=true]/day:ring-ring/50 dark:hover:text-accent-foreground flex aspect-square size-auto w-full min-w-(--cell-size) flex-col items-center justify-center gap-1 font-sans leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[2px] data-[range-end=true]:rounded-none data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-none data-[selected-single=true]:shadow-md data-[selected-single=true]:outline-2 [&>span]:text-xs',
        defaultClassNames.day,
        className,
      )}
      {...props}
