...
import { getAnnouncementCards, getEventCards, getNewsCards } from "@/data/news";
        ...
        <div className="space-y-4">
          {newsItems.map((item) => (
            <Link key={item.id} href={`/news/${item.slug}`} className="block">
              <Card className="flex flex-col gap-4 p-4 transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-md sm:flex-row">
