    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Giám sát sức khỏe và hiệu suất của hệ thống</p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              {healthyServices}/{totalServices} dịch vụ đang hoạt động tốt • Cập nhật lúc{' '}
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="border-border bg-card border-2 p-4 shadow-sm">
          ...
          <div className="bg-muted border-border h-2 border">
            <div className="h-full bg-green-500" style={{ width: `${metrics.disk.current}%` }} />
          </div>
          <p className="text-muted-foreground mt-1 text-xs">
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div key={service.name} className="border-border bg-card border-2 p-4 shadow-sm">
              <div className="flex items-start justify-between">
                ...
                <div
                  className={`h-3 w-3 rounded-full ${
                    service.status === 'healthy' ? 'bg-green-500' : 'animate-pulse bg-orange-500'
                  }`}
                />
              </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {recentIncidents.map((incident) => (
            <div key={incident.id} className="border-border bg-card border-2 p-4 shadow-sm">
