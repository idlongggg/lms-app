...
export default function CoinsPage() {
  return (
    <div className="space-y-8">
      ...
      {/* Balance Card */}
      <div className="border-2 border-primary bg-primary/20 p-6 shadow-sm">
        <div className="flex flex-col items-center gap-6 sm:flex-row">
          <div className="flex h-20 w-20 items-center justify-center border-2 border-border bg-primary text-4xl">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="border-2 border-border bg-background p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Kiếm được tháng này</p>
        ...
        <div className="border-2 border-border bg-background p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Đã chi tháng này</p>
