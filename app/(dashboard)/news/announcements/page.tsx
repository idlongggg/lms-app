import { Megaphone, Clock, Pin, Bell, ChevronRight, AlertCircle, CheckCircle, Info } from "lucide-react";
...
const typeConfig: Record<string, { icon: typeof AlertCircle; color: string; bgColor: string }> = {
  warning: {
    icon: AlertCircle,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button className="flex items-center gap-2 border-2 border-border bg-background px-4 py-2 text-sm font-medium shadow-xs transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-sm">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`flex h-10 w-10 shrink-0 items-center justify-center border-2 border-border bg-white ${config.color}`}
                    >
          ...
          {otherAnnouncements.map((announcement) => {
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`flex h-10 w-10 shrink-0 items-center justify-center border-2 border-border ${config.bgColor.split(" ")[0]} ${config.color}`}
                  >
                    <Icon className="h-5 w-5" />
                  </div>
                  <div className="flex-1">
      ...
      <div className="text-center">
        <button className="border-2 border-border bg-background px-6 py-2 font-medium shadow-xs transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-sm">
