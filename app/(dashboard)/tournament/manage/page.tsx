                  ...
                  <div className="flex items-center justify-end gap-1">
                    ...
                    {tournament.status === 'SCHEDULED' && (
                      <>
                        ...
                        <Button variant="outline" size="icon" className="hover:bg-green-100" title="Bắt đầu">
                          <Play className="h-4 w-4 text-green-500" />
                        </Button>
                      </>
                    )}
                    {tournament.status === 'ACTIVE' && (
                      <Button variant="outline" size="icon" className="hover:bg-orange-100" title="Tạm dừng">
