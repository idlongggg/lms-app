  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* Student Join Section - visible only with TOURNAMENT_JOIN permission */}
        <Can permission={PERMISSIONS.TOURNAMENT_JOIN}>
          <div className="border-border border-t-2 pt-6">
            <JoinTournamentSection />
          </div>
        </Can>

        {/* Parent Section - visible only with PROGRESS_READ_CHILD permission */}
