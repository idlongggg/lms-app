  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex items-center gap-4 border-2 border-border bg-background p-4 shadow-sm">
          <div className="flex h-12 w-12 items-center justify-center border-2 border-border bg-green-100">
            <CheckCircle className="h-6 w-6 text-green-600" />
          </div>
          <div>
            <p className="text-sm text-muted-foreground">Bài học hôm nay</p>
            <p className="text-xl font-bold">{todayStats.lessonsCompleted}</p>
          </div>
        </div>

        <div className="flex items-center gap-4 border-2 border-border bg-background p-4 shadow-sm">
          <div className="flex h-12 w-12 items-center justify-center border-2 border-border bg-blue-100">
        ...
        <div className="flex items-center gap-4 border-2 border-border bg-background p-4 shadow-sm">
          <div className="flex h-12 w-12 items-center justify-center border-2 border-border bg-yellow-100">
            <Star className="h-6 w-6 text-yellow-600" />
          </div>
          <div>
            <p className="text-sm text-muted-foreground">Xu kiếm được</p>
            <p className="text-xl font-bold">+{todayStats.coinsEarned}</p>
          </div>
        </div>

        <div className="flex items-center gap-4 border-2 border-border bg-background p-4 shadow-sm">
          <div className="flex h-12 w-12 items-center justify-center border-2 border-border bg-orange-100">
      ...
      <div className="border-2 border-border bg-background shadow-sm">
        ...
        <div className="divide-y-2 divide-border">
          {activities.map((activity) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex h-10 w-10 shrink-0 items-center justify-center border-2 border-border ${activity.color}`}
                >
        ...
        <div className="border-t-2 border-border p-4">
          <button className="w-full border-2 border-border bg-background py-2 font-medium shadow-xs transition-all hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-sm">
            Xem thêm hoạt động
          </button>
        </div>
      </div>
