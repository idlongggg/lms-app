...
export default function MyLearningPage() {
  ...
  return (
    <PageLayout title={t('learning.title')} description={t('learning.description')}>
        ...
        <div className="grid gap-4 sm:grid-cols-4">
          <Card className="p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground text-sm">{t('learning.totalSubjects')}</span>
            </div>
          ...
          <Card className="p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground text-sm">{t('learning.inProgress')}</span>
            </div>
          ...
          <Card className="p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground text-sm">{t('learning.completed')}</span>
            </div>
            <p className="mt-1 text-2xl font-bold">
          ...
          <Card className="p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-muted-foreground text-sm">{t('learning.totalLessons')}</span>
            </div>
            <p className="mt-1 text-2xl font-bold">
              ...
              >
                ...
                <div className="p-4">
                  <p className="text-muted-foreground text-sm">
                    {subject.completedLessons}/{subject.totalLessons} {t('learning.lessons')} (
                    {progress}%)
                  </p>
                  <Progress
                    value={progress}
