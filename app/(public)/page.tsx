            ...
            <div className="relative">
              <div className="border-border bg-background aspect-square border-4 p-8 shadow-xl">
                <div className="grid h-full grid-cols-2 gap-4">
                  <div className="border-border bg-accent border-2 p-4">
                    <BookOpen className="h-8 w-8" />
                    <p className="mt-2 font-medium">1000+ Bài học</p>
                  </div>
                  <div className="border-border bg-muted border-2 p-4">
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {features.map((feature, index) => (
              <div
                key={index}
                className="border-border bg-card border-2 p-6 shadow-md transition-all hover:-translate-x-1 hover:-translate-y-1 hover:shadow-lg"
              >
